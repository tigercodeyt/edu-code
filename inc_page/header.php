            ...
            <div class="itoffcanvas__info">
                ...
                <div class="it-info-wrapper mb-20 d-flex align-items-center">
                    ...
                    <div class="itoffcanvas__info-address">
                        <span>Email</span>
                        <a href="maito:info@esdc.edu.pk"><span class="__cf_email__"
                               >info@esdc.edu.pk</span></a>
                    </div>
                </div>
                <div class="it-info-wrapper mb-20 d-flex align-items-center">
                    <div class="itoffcanvas__info-icon">
                                ...
                                <ul class="text-center text-sm-start">
                                    ...
                                    <li class="d-none d-xl-inline-block">
                                        <a href="#">
                                            ...
                                            Near Sehat Foundation KKH Danyour Giligt
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-2 col-6">
                                    <div class="it-header-2-logo">
                                        <a href="index.php"><img src="assets/img/logo.png" alt width="80px"></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="it-header-2-main-menu">
                                        <nav class="it-menu-content">
                                            <ul>
                                                ...
                                                <li><a href="toopers.php">Our Toppers</a></li>
                                            ...
                                            <a class="it-btn" href="contact.html">
                                                <span>
                                                    ...
                                                    <svg width="17" height="14" viewBox="0 0 17 14" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M11 1.24023L16 7.24023L11 13.2402" stroke="white"
