                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="it-about-3-title-box">
                            ...
                            <h2 class="it-section-title-3 pb-30">we are always ensure best
                                 <span>Learning</span> for your
                            </h2>
                            <p>At our institution, we are unwavering in our commitment to providing the best possible learning experience for you. With a dedicated focus on excellence, we strive to create an environment where every student receives top-notch education, fostering growth, and ensuring a pathway to success. Your educational journey with us is not just a commitment; it's a promise to deliver unparalleled learning opportunities that empower and enrich. Join us as we embark together on a transformative adventure towards academic brilliance and personal development.</p>
                        </div>
        ...
        <div class="container" style="margin-top:20px">
            <div class="row">
                <center><div class="col ">
                    <span class="asder">MUHAMMAD KAZIM</span>
                    <img class="" src="assets/tec_img/WhatsApp Image 2024-03-06 at 00.00.00_6c6535fc.jpg" alt="" style="border-radius: 20px ;">
<div class="cont_txt"><br>
  <b style="color:#0AB99D;">Principal</b> of Education School & Degree College
</div>
                </div></center>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                        <div class="it-team-3-item text-center">
                            <div class="it-team-3-thumb fix">
                                <img src="assets/tec_img/IMG-20240305-WA0017.jpg" alt>
                            </div>
                            <div class="it-team-3-content">
                                <div class="it-team-3-author-box">
                                    <h4 class="it-team-3-title"><a>Muhammad Ali</a></h4>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                        <div class="it-team-3-item text-center">
                            ...
                            <div class="it-team-3-content">
                                <div class="it-team-3-author-box">
                                    <h4 class="it-team-3-title"><a>Sher Dil Hussain</a></h4>
                                    <span>Teacher</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                        <div class="it-team-3-item text-center">
                            ...
                            <div class="it-team-3-content">
                                <div class="it-team-3-author-box">
                                    <h4 class="it-team-3-title"><a>Anam Zahara</a></h4>
                                    <span>Teacher</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                        <div class="it-team-3-item text-center">
                            ...
                            <div class="it-team-3-content">
                                <div class="it-team-3-author-box">
                                    <h4 class="it-team-3-title"><a>Altaf Hussain</a></h4>
                                    <span>Teacher</span>
                                </div>
                            </div>
                        </div>
